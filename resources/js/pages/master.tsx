                ...
                <header className="w-full border-b border-border/50 bg-background/80 backdrop-blur-sm">
                    <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
                        <div className="flex items-center gap-2">
                            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-brand-gradient text-brand-primary-foreground shadow-lg sm:h-10 sm:w-10">
                ...
                <main className="flex flex-1 items-center justify-center px-4 py-12 sm:px-6 sm:py-20">
                    <div className="mx-auto max-w-6xl">
                        <div className="text-center">
                            <h1 className="mb-4 text-4xl font-bold tracking-tight text-foreground sm:mb-6 sm:text-6xl lg:text-7xl xl:text-8xl">
                                Connect in
                            ...
                            <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground sm:mb-12 sm:text-xl lg:text-2xl">
                            ...
                            {!auth.user && (
                                <div className="mx-auto mb-12 max-w-4xl sm:mb-16">
                                    <h2 className="mb-6 text-3xl font-bold text-foreground sm:mb-8 sm:text-4xl lg:text-5xl">
                        ...
                        <div className="mt-12 grid gap-6 sm:mt-16 sm:grid-cols-2 sm:gap-8 lg:grid-cols-3">
                            <div className="group rounded-2xl border border-border bg-card/50 p-6 backdrop-blur-sm transition-all hover:border-brand-primary hover:shadow-xl sm:p-8">
                            ...
                            <div className="group rounded-2xl border border-border bg-card/50 p-6 backdrop-blur-sm transition-all hover:border-brand-secondary hover:shadow-xl sm:p-8">
                                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-brand-muted sm:h-14 sm:w-14">
                            ...
                            <div className="group rounded-2xl border border-border bg-card/50 p-6 backdrop-blur-sm transition-all hover:border-brand-accent hover:shadow-xl sm:p-8 sm:col-span-2 lg:col-span-1">
                                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-brand-muted sm:h-14 sm:w-14">
